...
class Ui_LoginSignupWindow(object):
    def setupUi(self, LoginSignupWindow):
        ...
        LoginSignupWindow.setStyleSheet("background-image: url(:/Background/background/darkgreen.png);\n""")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/Icons/Icons/signup.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, LoginSignupWindow):
        ...
        LoginSignupWindow.setWindowTitle(_translate("LoginSignupWindow", "Login/SignUp"))
    ...
    def open_login_window(self):
        ...
        self.ui = Ui_LoginWindow(self.LoginSignupWindow)  #* Pass the main window reference here
